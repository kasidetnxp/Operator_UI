                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-muted-foreground">
                            {task.type === 'return' ? t.returnFPC : task.type === 'request' ? t.requestFPC : task.type === 'unload_load' ? t.unloadLoadFPC : t.moveFPC}
                          </div>
                  ...
                  <div className="bg-background rounded-lg p-6 space-y-4">
                    ...
                    <div className="flex justify-between text-xl border-b border-border pb-3">
                      ...
                      <span className="font-bold text-foreground">
                        {selectedTask.type === 'return' ? t.returnFPC : selectedTask.type === 'request' ? t.requestFPC : selectedTask.type === 'unload_load' ? t.unloadLoadFPC : t.moveFPC}
                      </span>
                    </div>
                    {selectedTask.fpcId && (
                      <div className="flex justify-between text-xl border-b border-border pb-3">
